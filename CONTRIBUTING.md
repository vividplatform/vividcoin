Contributing to Vivid Core
==================================

The Vivid Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vivid Core project, and is not to be
confused with overall Vivid Network Protocol consensus changes.

Whether a pull request is merged into Vivid Core rests with the project merge
...
Patches that change Vivid consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vivid consensus, it must have been
...
The project leader is the release manager for each Vivid Core release.

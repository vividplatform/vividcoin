...
RESOURCES += src/qt/vivid.qrc src/qt/vivid_locale.qrc

TRANSLATIONS += src/qt/locale/vivid_bg.ts \
                src/qt/locale/vivid_de.ts \
                src/qt/locale/vivid_en.ts \
                src/qt/locale/vivid_es.ts \
                src/qt/locale/vivid_fi.ts \
                src/qt/locale/vivid_fr.ts \
                src/qt/locale/vivid_it.ts \
                src/qt/locale/vivid_ja.ts \
                src/qt/locale/vivid_pl.ts \
                src/qt/locale/vivid_pt.ts \
                src/qt/locale/vivid_ru.ts \
                src/qt/locale/vivid_sk.ts \
                src/qt/locale/vivid_sv.ts \
                src/qt/locale/vivid_vi.ts \
                src/qt/locale/vivid_zh_CN.ts \
                src/qt/locale/vivid_zh_TW.ts

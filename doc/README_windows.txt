...
Intro
-----
Vivid (VIVID) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Vivid utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run vivid-qt.exe.

Vivid Core is the original Vivid client and it builds the backbone of the network.
However, it downloads and stores the entire history of Vivid transactions;

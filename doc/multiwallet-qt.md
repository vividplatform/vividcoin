...
In order to support loading of multiple wallets in vivid-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vivid.cpp.
...
Changes to vivid.cpp
----------------------
vivid.cpp is the entry point into vivid-qt, and as such, will require some minor modifications to provide hooks for

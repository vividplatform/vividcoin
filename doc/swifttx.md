...
This mechanism has been integrated into Bitcore-Node-Vivid which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vividplatform/insight-api-vivid#web-socket-api](https://github.com/vividplatform/insight-api-vivid#web-socket-api)
* API: [https://github.com/vividplatform/insight-api-vivid#swifttx-transactions](https://github.com/vividplatform/insight-api-vivid#swifttx-transactions)
...
By default, the Vivid Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vivid Core daemon:

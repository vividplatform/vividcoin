...
#   c) node1 mines 32 blocks, so now node 0 has 500000VIVID, node 1 has 4250VIVID, node2 has none.
#   d) node0 sends 601 VIVID to node2, in two transactions (301 VIVID, then 300 VIVID).

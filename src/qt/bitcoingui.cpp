                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vivid Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VIVID address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vivid: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vivid Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vivid Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vivid"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VIVID addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VIVID addresses"));
    ...
    openAction->setStatusTip(tr("Open a vivid: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vivid Core help message to get a list with possible Vivid command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vivid Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vivid network", "", count));
}
...
{
    QString strTitle = tr("Vivid Core"); // default title

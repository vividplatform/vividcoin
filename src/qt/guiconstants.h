...
/* Vivid GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Vivid"
#define QAPP_ORG_DOMAIN "vividcoin.app"
#define QAPP_APP_NAME_DEFAULT "Vivid-Qt"
#define QAPP_APP_NAME_TESTNET "Vivid-Qt-testnet"

...
/** Utility functions used by the Vivid Qt UI.
 */
namespace GUIUtil
{
...
// Render VIVID addresses in monospace font
...
// Parse "vivid:" URI into recipient object, return true on successful parsing

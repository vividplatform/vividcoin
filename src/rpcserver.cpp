...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vivid features */
        {"vivid", "masternode", &masternode, true, true, false},
        {"vivid", "listmasternodes", &listmasternodes, true, true, false},
        {"vivid", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vivid", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vivid", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vivid", "masternodedebug", &masternodedebug, true, true, false},
        {"vivid", "startmasternode", &startmasternode, true, true, false},
        {"vivid", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vivid", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vivid", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vivid", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vivid", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vivid", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vivid", "mnbudget", &mnbudget, true, true, false},
        {"vivid", "preparebudget", &preparebudget, true, true, false},
        {"vivid", "submitbudget", &submitbudget, true, true, false},
        {"vivid", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vivid", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vivid", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vivid", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vivid", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vivid", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vivid", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vivid", "checkbudgets", &checkbudgets, true, true, false},
        {"vivid", "mnsync", &mnsync, true, true, false},
        {"vivid", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> vivid-cli " + methodname + " " + args + "\n";
}
